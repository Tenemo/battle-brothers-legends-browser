...
describe('build social image', () => {
  ...
  test('renders picked perks and background fits into the SVG without duplicated sections', () => {
    ...
    expect(svg).toContain('<rect x="48" y="64" width="528"')
    expect(svg).toContain('<rect x="624" y="408" width="528" height="194"')
    expect(svg).toContain('<text x="664" y="96"')
    expect(svg).toContain('<text x="4" y="624"')
    expect(svg).toContain('battlebrothers.academy')
    expect(svg).toContain('<line x1="4" y1="628" x2="250"')
